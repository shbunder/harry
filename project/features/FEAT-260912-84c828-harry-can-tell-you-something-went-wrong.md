...
- **2026-09-14** — 2026-09-14: verified against a real workspace. make test-live ARGS=tests/test_slack_connector.py posted to #mykate_cowork and the line arrived. That was the one claim this feature shipped without evidence — the recorded fixtures prove what Harry sends and what it does with what comes back, and nothing could prove a message lands until somebody had a token and had invited the bot.
