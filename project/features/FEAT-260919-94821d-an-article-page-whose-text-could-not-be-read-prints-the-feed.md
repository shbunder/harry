...
- [ ] A KW story whose text could not be read prints its summary on its page as text — its sentences, "…" for `&#8230;`, no tag, no character code — and without WordPress's "The post … appeared first on KW.be." footer
- [ ] A ROB tv story whose text could not be read prints no `&nbsp;` and no character code on its page
- [ ] A De Tijd summary with a real ampersand ("politiek & economie") prints the ampersand as written
- [ ] The second sheet's summary line for a KW story is unchanged: its first sentence as text
