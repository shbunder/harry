...
# Requirements — FEAT-260919-f11974 The weather panel says Weather unavailable when there is no forecast

## Context & problem

A missing forecast draws a panel of dashes. The docs say it prints `Weather unavailable`.
See the feature's summary for where each claim lives. The rest of this page is not written
yet: this item is in Backlog.
